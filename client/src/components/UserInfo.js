...
const UserInfo = ({ myUsername, timestamp, sendRequest, disabled, subtext, color }) => {
  return (
          ...
          <Content>
            <p>
              ...
              <br />
              {
                ...
                <Button disabled={disabled} fullwidth rounded color="info" onClick={() => { sendRequest(myUsername) }}>Share Picture</Button>
              }
              {subtext}
            </p>
          </Content>
